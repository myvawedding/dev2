...
class GMW_PS_GL_Form_Settings {
    ...
    public function default_settings( $settings, $args ) {
        ...
        if ( $form['component'] == 'bp_groups_locator' ) {
    ...
    public function include_exclude_bp_group_types( $value, $name_attr ) {
        ...
        if ( empty( $group_types ) ) {
            ?>
            <p><?php _e( 'No group types were found.', 'gmw-premium-settings' ); ?></p>
        ...
        <div class="gmw-options-box bp-include-exclude-group-types-settings-wrapper">  
            ...
            <div class="single-option usage">   
                ...
                <div class="option-content">
                    ...
                    <p class="description">
                        <?php _e( 'Select to disable, include or exclude group type.', 'gmw-premium-settings' ); ?>
                    </p>
                </div>
            </div>
            ...
            <div class="single-option terms">   
                ...
                <label><?php _e( 'Group types to include or exclude', 'gmw-premium-settings' ); ?></label>  
                
                <div class="option-content">

                    <?php $set_taxes = ! empty( $value['group_types'] ) ? $value['group_types'] : array(); ?>

                    <select multiple name="<?php echo $name_attr; ?>[group_types][]">

                        <?php foreach ( $group_types as $group_type ) { ?>
                                                        
                            <?php $selected = ( isset( $value['group_types'] ) && in_array( $group_type->name, $value['group_types'] ) ) ? 'selected="selected"' : ''; ?>
                            
                            <option <?php echo $selected; ?> value="<?php echo esc_attr( $group_type->name ); ?>"><?php echo esc_html( $group_type->labels['name'] ); ?></option>
                        <?php } ?>

                    </select>

                    <p class="description">
                        <?php _e( 'Select the group types to include or exclude.', 'gmw-premium-settings' ); ?>
                    </p>
                </div>
        ...
        <div class="bp-group-types-settings-wrapper gmw-options-box">
            ...
            <div class="bp-group-types-setting single-option usage">  
                ...
                <div class="option-content">
                    ...
                    <p class="description">
                        <?php _e( 'Select "Pre defined" to omit the filter from the search form, but your can still filter group types based on the selected types below. Otherwise, select how to display the filter in the search from.', 'gmw-premium-settings' ); ?>
                    </p>
                </div>
            </div>
            ...
            <div class="bp-group-types-setting single-option groups">
                <label>
                    <?php echo _e( 'Select Group Types', 'gmw-premium-settings' ); ?> 
                </label>
                <div class="option-content">
                    ...
                    <p class="description">
                        <?php _e( 'Select group types to use in the filter or leave blank to use all types.', 'gmw-premium-settings' ); ?>
                    </p>
                </div>
            </div>
