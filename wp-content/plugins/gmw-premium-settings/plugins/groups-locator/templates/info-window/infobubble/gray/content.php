 ...
 * your-theme's-or-child-theme's-folder/geo-my-wp/groups-locator/info-window/infobubble/
 * 
 ...
 * $group - the group being displayed ( object )
 */
?>
<div class="gmw-info-window-inner infobubble">
	...
	<a class="title" href="<?php bp_group_permalink(); ?>">
		<?php bp_group_name(); ?>
	</a>
