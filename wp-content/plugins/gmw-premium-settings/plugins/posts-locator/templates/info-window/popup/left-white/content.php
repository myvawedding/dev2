 ...
 * your-theme's-or-child-theme's-folder/geo-my-wp/posts-locator/info-window-templates/popup/
 * 
...
<div id="gmw-toggle-button-wrapper">
	<?php gmw_left_window_toggle_button(); ?>
</div>

<?php echo gmw_element_close_button( 'gmw-icon-cancel' ); ?>
