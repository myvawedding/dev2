...
class GMW_PS_Form_Settings_Helper {
	...
	public static function keywords_field( $value, $name_attr, $form ) {
		...
		<div class="keywords-options-wrapper gmw-options-box" <?php echo $display; ?>>		
	...
	<p>
		<select name="<?php echo esc_attr( $name_attr ); ?>[usage]" id="address-fields-usage">
			...
			<option value="multiple" <?php if ( ! empty( $value['usage'] ) && $value['usage'] == 'multiple' ) ?>>
	...
	<div class="address-fields-settings-wrapper">
		...
		<div class="gmw-options-box gmw-address-fields-settings multiple" style="display:none;">  
            ...
            <?php $address_fields = array( 'street', 'city', 'state', 'zipcode', 'country' ); ?>
            	...
            	?>
                <?php foreach ( $address_fields as $field ) : $sy = false; ?>
                	<?php 
	            	...
	            	<div class="single-address-field-raw">                   
	                    <div class="single-option usage third <?php if ( $value['multiple'][$field]['usage'] == 'disabled' ) echo 'disabled'; ?>">
	                    	<label>
	                    ...
	                    <div class="address-fields-settings default" <?php if ( $value['multiple'][$field]['usage'] != 'default' ) echo 'style="display:none"'; ?>>
	                    ...
	                    <div class="address-fields-settings include" <?php if ( $value['multiple'][$field]['usage'] != 'include' ) echo 'style="display:none"'; ?>>
	...
	/**
	 * [validate_radius_slider description]
	 * @param  [type] $output [description]
	 * @return [type]         [description]
	 */
	 ...
	 * 
	 * @param  string $preix [description]
	 * @return [type]        [description]
	 */
	 ...
	 * @param  boolean $form_id [description]
	 * @return [type]           [description]
	 */
	...
	public static function validate_results_found_message( $output ) {
		...
		$output['count_message']  = isset( $output['count_message'] ) ? sanitize_text_field( $output['count_message'] ) : '';
		$output['location_message'] = isset( $output['location_message'] ) ? sanitize_text_field( $output['location_message'] ) : '';
	...
	/**
	 * Validarte wider search settings 
	 * 
	 * @param  [type] $output [description]
	 * @return [type]         [description]
	 */
	public function validate_wider_search( $output ) {
	 ...
	 * @return [type]         [description]
	 */
	public function validate_no_results_message( $output ) {
            ...
            <div id="gmw-map-styles-wrapper">
                ...
                <?php foreach ( ( array ) $styles as $index => $style ) { ?> 
                	...
                	<div class="single-map-style">       		
	                   	<label>
	                	 	<img 
	                	 		src="<?php echo esc_url( $style['imageUrl'] ); ?>" 
	                        ...
	                        <input 
	                    		...
	                    		name="<?php echo $name_attr; ?>" 
	                    		<?php if ( ! empty( $value ) && $value == $style['id'] ) { echo 'checked="checked"'; } ?>
	                    	/>
